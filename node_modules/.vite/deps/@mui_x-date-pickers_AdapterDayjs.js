...
var AdapterDayjs = class {
  constructor({
    ...
    this.createTZDate = (value, timezone) => {
      ...
      const cleanTimezone = timezone === "default" ? void 0 : timezone;
      const keepLocalTime = value !== void 0 && !value.endsWith("Z");
      return (0, import_dayjs.default)(value).tz(cleanTimezone, keepLocalTime);
    };
    ...
    this.setTimezone = (value, timezone) => {
      ...
      const cleanZone = timezone === "default" ? void 0 : timezone;
      return import_dayjs.default.tz(value, cleanZone);
    };
    this.toJsDate = (value) => {
      return value.toDate();
    };
