...
} from "./chunk-BVVFRF62.js";
import {
  createSvgIcon
} from "./chunk-AAEYOHAX.js";
import {
  Paper_default
} from "./chunk-WH2FF3XQ.js";
import {
  FocusTrap_default,
  init_utils,
  resolveComponentProps,
  useSlotProps
} from "./chunk-VJINLL52.js";
import {
  buildWarning
...
} from "./chunk-ZBIKGDN4.js";
import "./chunk-K3RD6K65.js";
import {
  useTheme
} from "./chunk-74WHU4OM.js";
import {
...
var require_useEnhancedEffect = __commonJS({
  "node_modules/@mui/utils/useEnhancedEffect.js"(exports) {
    ...
    var useEnhancedEffect3 = typeof window !== "undefined" ? React45.useLayoutEffect : React45.useEffect;
...
var require_useEventCallback = __commonJS({
  "node_modules/@mui/utils/useEventCallback.js"(exports) {
    ...
    exports.default = useEventCallback9;
    var React45 = _interopRequireWildcard(require_react());
    ...
    function useEventCallback9(fn) {
      const ref = React45.useRef(fn);
      (0, _useEnhancedEffect.default)(() => {
        ref.current = fn;
      });
      return React45.useCallback((...args) => (
...
var require_useControlled = __commonJS({
  "node_modules/@mui/utils/useControlled.js"(exports) {
    ...
    function useControlled3({
      ...
      } = React45.useRef(controlled !== void 0);
      const [valueState, setValue] = React45.useState(defaultProp);
      ...
      const setValueIfUncontrolled = React45.useCallback((newValue) => {
        if (!isControlled) {
          setValue(newValue);
        }
      }, []);
...
var require_useId = __commonJS({
  "node_modules/@mui/utils/useId.js"(exports) {
    ...
    var maybeReactUseId = React45["useId".toString()];
...
var useFieldState = (params) => {
  ...
  const sectionsValueBoundaries = React12.useMemo(() => getSectionsBoundaries(utils), [utils]);
...
var usePickerValue = ({
  ...
  const updateDate = (0, import_useEventCallback3.default)((action) => {
    const updaterParams = {
      action,
      dateState,
  ...
  const handleClear = (0, import_useEventCallback3.default)(() => {
    updateDate({
      value: valueManager.emptyValue,
  ...
  const handleAccept = (0, import_useEventCallback3.default)(() => {
    updateDate({
  ...
  const handleDismiss = (0, import_useEventCallback3.default)(() => {
    updateDate({
      value: dateState.lastPublishedValue,
      name: "setValueFromAction",
  ...
  const handleCancel = (0, import_useEventCallback3.default)(() => {
    updateDate({
  ...
  const handleSetToday = (0, import_useEventCallback3.default)(() => {
    updateDate({
  ...
  const handleOpen = (0, import_useEventCallback3.default)(() => setIsOpen(true));
  const handleClose = (0, import_useEventCallback3.default)(() => setIsOpen(false));
  const handleChange = (0, import_useEventCallback3.default)((newValue, selectionState = "partial") => updateDate({
    name: "setValueFromView",
    value: newValue,
    selectionState
  }));
  const handleChangeField = (0, import_useEventCallback3.default)((newValue, context) => updateDate({
    name: "setValueFromField",
    value: newValue,
    context
  }));
  const handleFieldSelectedSectionsChange = (0, import_useEventCallback3.default)((newSelectedSections) => {
...
function useViews({
  ...
  const handleFocusedViewChange = (0, import_useEventCallback4.default)((viewToFocus, hasFocus) => {
    if (hasFocus) {
  ...
  const handleChangeView = (0, import_useEventCallback4.default)((newView) => {
    if (newView === view) {
      return;
    }
    setView(newView);
  ...
  const goToNextView = (0, import_useEventCallback4.default)(() => {
    if (nextView) {
      handleChangeView(nextView);
    }
    handleFocusedViewChange(nextView, true);
  });
  const setValueAndGoToNextView = (0, import_useEventCallback4.default)((value, currentViewSelectionState, selectedView) => {
  ...
  const setValueAndGoToView = (0, import_useEventCallback4.default)((value, newView, selectedView) => {
...
var usePickerViews = ({
  ...
  const shouldRestoreFocus = (0, import_useEventCallback5.default)(() => currentViewMode === "UI");
...
var _excluded9 = ["items", "isLandscape", "onChange", "isValid"];
...
function DayCalendar(inProps) {
  ...
  const handleDaySelect = (0, import_useEventCallback6.default)((day) => {
    if (readOnly) {
      return;
    }
  ...
  const handleKeyDown = (0, import_useEventCallback6.default)((event, day) => {
    switch (event.key) {
      case "ArrowUp":
  ...
  const handleFocus = (0, import_useEventCallback6.default)((event, day) => focusDay(day));
  const handleBlur = (0, import_useEventCallback6.default)((event, day) => {
...
var PickersMonth = React35.memo(function PickersMonth2(inProps) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersMonth"
  });
...
var _excluded17 = ["className", "value", "defaultValue", "disabled", "disableFuture", "disablePast", "maxDate", "minDate", "onChange", "shouldDisableMonth", "readOnly", "disableHighlightToday", "autoFocus", "onMonthFocus", "hasFocus", "onFocusedViewChange", "monthsPerRow"];
...
var MonthCalendar = React36.forwardRef(function MonthCalendar2(inProps, ref) {
  const now = useNow();
  ...
  const todayMonth = React36.useMemo(() => utils.getMonth(now), [utils, now]);
  const selectedDateOrStartOfMonth = React36.useMemo(() => value != null ? value : utils.startOfMonth(now), [now, utils, value]);
  const selectedMonth = React36.useMemo(() => {
    if (value != null) {
  ...
  const [focusedMonth, setFocusedMonth] = React36.useState(() => selectedMonth || todayMonth);
  const [internalHasFocus, setInternalHasFocus] = useControlled({
    name: "MonthCalendar",
    state: "hasFocus",
    controlled: hasFocus,
  ...
  const isMonthDisabled = React36.useCallback((month) => {
    const firstEnabledMonth = utils.startOfMonth(disablePast && utils.isAfter(now, minDate) ? now : minDate);
    const lastEnabledMonth = utils.startOfMonth(disableFuture && utils.isBefore(now, maxDate) ? now : maxDate);
...
var PickersYear = React37.memo(function PickersYear2(inProps) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersYear"
  });
...
var _excluded19 = ["autoFocus", "className", "value", "defaultValue", "disabled", "disableFuture", "disablePast", "maxDate", "minDate", "onChange", "readOnly", "shouldDisableYear", "disableHighlightToday", "onYearFocus", "hasFocus", "onFocusedViewChange", "yearsPerRow"];
...
var YearCalendar = React38.forwardRef(function YearCalendar2(inProps, ref) {
  const now = useNow();
  const theme = useTheme_default();
  const utils = useUtils();
  ...
  const selectedDateOrStartOfYear = React38.useMemo(() => value != null ? value : utils.startOfYear(now), [now, utils, value]);
  const todayYear = React38.useMemo(() => utils.getYear(now), [utils, now]);
  const selectedYear = React38.useMemo(() => {
    if (value != null) {
  ...
  const [focusedYear, setFocusedYear] = React38.useState(() => selectedYear || todayYear);
  const [internalHasFocus, setInternalHasFocus] = useControlled({
    name: "YearCalendar",
    state: "hasFocus",
    controlled: hasFocus,
  ...
  const isYearDisabled = React38.useCallback((dateToValidate) => {
  ...
  const scrollerRef = React38.useRef(null);
...
var DateCalendar = React39.forwardRef(function DateCalendar2(inProps, ref) {
  const utils = useUtils();
  const id = useId();
  ...
  const prevOpenViewRef = React39.useRef(view);
  React39.useEffect(() => {
  ...
  const selectedDays = React39.useMemo(() => [value], [value]);
...
// node_modules/@mui/x-date-pickers/DesktopDatePicker/DesktopDatePicker.js
var DesktopDatePicker = React41.forwardRef(function DesktopDatePicker2(inProps, ref) {
...
var DatePicker = React44.forwardRef(function DatePicker2(inProps, ref) {
  ...
  if (isDesktop) {
    return (0, import_jsx_runtime37.jsx)(DesktopDatePicker, _extends({
      ref
    }, other));
  }
  return (0, import_jsx_runtime37.jsx)(MobileDatePicker, _extends({
    ref
  }, other));
});
